        ...
        <>
            ...
            <div className=" bg-black h-auto min-h-screen mx-auto max-w-6xl overflow-hidden">
                <div className="flex inset-0 -z-10 overflow-hidden">
                    ...
                    <div
                        className="absolute -z-9 bottom-0 left-0 w-96 h-96 bg-blue-600 rounded-full filter blur-3xl opacity-20 animate-pulse"
                        style={{ animationDelay: "2s" }}
                    ></div>
                    <div
                        className="absolute -z-9 top-[40%] left-1/3 w-64 h-64 bg-cyan-500 rounded-full filter blur-3xl opacity-10 animate-pulse"
