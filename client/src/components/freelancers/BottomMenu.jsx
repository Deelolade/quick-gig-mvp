            ...
            <div>
                <div className="bottombar bg-black h-[10vh] md:h-[9vh] fixed  bottom-0 w-[100vw] lg:hidden text-white md:px-5 py-2  flex justify-between shadow-md">
                        <div className="links w-[100vw] flex justify-evenly items-center  ">
                            ...
                            <Link to='/browse-gigs' className={`text-[13px] md:text-[15px]  font-bold  text-center flex flex-col justify-center items-center `}><RiContractFill className={`text-5xl   my-1 rounded-md me-3  hover:bg-gray-500 px-2 py-2 ${location.pathname === '/browse-gigs' ? 'bg-gray-500' : ''}`} />Browse Jobs</Link>
