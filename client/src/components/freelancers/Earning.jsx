...
const Earning = () => {
  return (
    <div className=''>
        <section className=' flex justify-center items-center bg-blue-950  md:h-[70vh] py-24 bg-gradient-to-tr mx-auto overflow-hidden from-black/40 via-purple-600/30  to-purple-800/35'>
          ...
          <div className="text-center p-6 bg-purple-950 md:h-36 w-[90%] md:w-[70%] mx-auto mt-10 border border-gray-600 rounded-xl">
            <h3 className='text-lg md:text-2xl font-semibold text-white mb-4'>Want to be notified when it's ready?</h3>
            <div className="flex w-auto justify-center  ">
              <input type="text"
              placeholder='Your Email Address' 
              className='md:w-[70%] mx-2 md:mx-4 outline-none px-3 rounded-md  font-normal text-purple-500' />
              <button className='text-sm md:text-lg  font-semibold text-white bg-purple-600 hover:bg-purple-800 py-2 px-2 md:px-3 rounded-lg'>Notify me</button>
            </div>
          </div>
