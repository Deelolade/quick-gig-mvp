            ...
            <div className="sidebar bg-black w-[15%] h-[100%] fixed text-white px-5 py-4 flex flex-col justify-between shadow-md">
                <div className="w-[100%] px-3">
                    ...
                    <div className="links w-auto flex flex-col">
                        <Link to='/dashboard' className='text-sm font-semibold w-full hover:bg-gray-500 px-2 py-2 rounded-md flex items-center'><GoHomeFill className='text-xl me-1' />Home</Link>
                        <Link to='/post-gigs' className='text-sm font-semibold w-full hover:bg-gray-500 px-2 py-2 rounded-md'>Post a Job</Link>
                        <Link to='/browse' className='text-sm font-semibold w-full hover:bg-gray-500 px-2 py-2 rounded-md'>Browse Freelancers</Link>
                        ...
                        <Link to='/payments' className='text-sm font-semibold w-full hover:bg-gray-500 px-2 py-2 rounded-md'>Payment</Link>
                    </div>
                </div>
