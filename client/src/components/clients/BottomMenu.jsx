            ...
            <div>
                <div className="bottombar bg-black  h-[9vh] md:h-[9vh] fixed  bottom-0 w-[100vw] lg:hidden text-white md:px-5 py-2  flex justify-between shadow-md">
                    <div className="links w-[100vw] flex justify-evenly items-center  ">
                        ...
                        <Link to='/post-gigs' className={`text-[12px]  md:text-[15px]  font-bold  text-center flex flex-col justify-center items-center`}>
                            <RiContractFill className={`text-5xl   my-1 rounded-md me-3   hover:bg-gray-500 px-2 ${location.pathname === '/post-gigs' ? 'bg-gray-500' : ''}`} />
                            <p className='hidden md:block' >
                                Post Gigs
                            </p>
                        </Link>

                        <Link to='/browse' className={`text-[12px]  md:text-[15px]  font-bold  text-center flex flex-col justify-center items-center`}>
                            <RiFileList2Fill className={`text-5xl   my-1 rounded-md me-3   hover:bg-gray-500 px-2 ${location.pathname === '/browse' ? 'bg-gray-500' : ''}`} />
                            <p className='hidden md:block' >
                                Freelancers
                            </p>
                        </Link>
